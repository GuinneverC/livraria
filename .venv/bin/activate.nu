...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/aluno/Música/Guinness3info2/livraria/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('livraria-py3.8' == '') {
...
alias deactivate = source '/home/aluno/Música/Guinness3info2/livraria/.venv/bin/deactivate.nu'
